<?php
    ...
    $comprueba = "SELECT pok_id FROM pokemon WHERE "
    
    $sql = "INSERT INTO pokemon VALUES (null, '$nombre', $altura, $peso, $exp_base)";
    $res = mysqli_query($con, $sql);

    if($res == false){
        $respuesta = array("ok" => false, "texto" => "No se pudo ingresar D:");
        ...
        $respuesta = array("ok" => true, "id" => $id, "texto" => "Ha sido ingredado correctamente");
        echo json_encode($respuesta);
    }
